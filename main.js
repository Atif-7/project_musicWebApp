...
function play_song(){
  ...
  song_img.innerHTML = `<img src="${songs[index_no].img}" />`;
  playing_img.innerHTML = `<img src="${songs[index_no].img}" />`;

  song_name.innerHTML = songs[index_no].name;
  artist_name.innerHTML = songs[index_no].singer;

  current_track_name.innerHTML = songs[index_no].name;
  current_singer_name.innerHTML = songs[index_no].singer;
